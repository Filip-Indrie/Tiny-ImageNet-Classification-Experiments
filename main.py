...
if __name__ == "__main__":
    ...
    print("AlexNet")
    train_loss_alexnet, train_acc_alexnet, val_loss_alexnet, val_acc_alexnet = train(alexnet, train_iter, val_iter, num_epochs, patience, loss, optimizer_alexnet, device)

    print("VGG11")
    train_loss_vgg11, train_acc_vgg11, val_loss_vgg11, val_acc_vgg11 = train(vgg11, train_iter, val_iter, num_epochs, patience, loss, optimizer_vgg11, device)

    print("ResNet18")
    train_loss_resnet18, train_acc_resnet18, val_loss_resnet18, val_acc_resnet18 = train(resnet18, train_iter, val_iter, num_epochs, patience, loss, optimizer_resnet18, device)
